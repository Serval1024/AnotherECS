...
namespace AnotherECS.Core
{
    ...
    public unsafe partial struct ArchetypeCollection : ISerialize //TODO internal
    {
        ...
        //public int GetItems(uint archetypeId)
        //{
        ...
        private void PatternDownExtend(uint* result, ref int resultCount)
        {
        ...
        private void PatternDownExtend(ref Node node, uint* result, ref int resultCount)
        {
