...
namespace AnotherECS.Essentials.Physics.Components
{
    ...
    public struct PhysicsConstrainedBodyPair : IComponent
    {
        ...
        /// </summary>
        [CreateProperty]
        public EntityId EntityA => Entities.EntityA;
        /// <summary>
        /// The second entity in the pair.
        /// </summary>
        [CreateProperty]
        public EntityId EntityB => Entities.EntityB;

        public PhysicsConstrainedBodyPair(EntityId entityA, EntityId entityB, bool enableCollision)
        {
