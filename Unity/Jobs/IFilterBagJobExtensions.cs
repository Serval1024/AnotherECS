...
namespace AnotherECS.Unity.Jobs
{
    ...
    public interface IJobFilterBag<T>
    ...
    {    
        public static JobHandle Schedule<T, TBag>(this T jobData, TBag bag, JobHandle inputDeps = default)
            where T : struct, IJobFilterBag<TBag>
            ...
            where TBag : struct, IJobBag
        {
            ...
            return JobsUtility.ScheduleParallelFor(ref parameters, 1, JobBagUtils.GetScheduleBatchCount(bag.Count));
