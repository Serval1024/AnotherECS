...
namespace AnotherECS.Core.Collection
{
...
#endif
    public unsafe struct NHashSet<TAllocator, TValue, THashProvider> : INHashSet<TValue>, ISerialize, IRepairMemoryHandle
        ...
        where THashProvider : struct, IHashProvider<TValue, uint>
    {
        ...
        public struct Enumerator : IEnumerator<TValue>, IEnumerator
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal Enumerator(in NHashSet<TAllocator, TValue, THashProvider> data)
            {
                _data = data;
                _index = 0;
                _current = default;
